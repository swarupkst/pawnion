...
<head>
  ...
  <title>PawNion - Post for Adoption</title>
...
<body class="bg-[#F6F7F8] min-h-screen flex flex-col items-center justify-center px-4 py-10">
  ...
  <!-- Container -->
  <div class="bg-[#FEFFFE] shadow-lg rounded-3xl w-full max-w-2xl p-8 sm:p-10">
        ...
        <div class="flex items-center gap-6">
          <label class="flex items-center gap-2">
            <input type="radio" name="gender" value="Male" required
              class="text-[#68AADB] focus:ring-[#68AADB]">
            <span>Male</span>
          </label>
          <label class="flex items-center gap-2">
            <input type="radio" name="gender" value="Female"
              class="text-[#E8793C] focus:ring-[#E8793C]">
            <span>Female</span>
          </label>
        </div>
      </div>
